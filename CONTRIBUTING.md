...
issue](https://github.com/cisagov/was_report/issues) in
...
request](https://github.com/cisagov/was_report/pulls),
...
```console
cd was_report
pyenv virtualenv <python_version_to_use> was_report
pyenv local was_report
